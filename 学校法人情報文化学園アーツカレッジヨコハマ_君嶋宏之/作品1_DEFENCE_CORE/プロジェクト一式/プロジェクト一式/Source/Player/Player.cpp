...
Player::Player()
{
	...
	sphereColl->SetTargetTag(COLLISION_OBJECT_KIND::BACK_BLOCK);
...
{
	if (_targetData.tag == COLLISION_OBJECT_KIND::GROUND_BLOCK || _targetData.tag == COLLISION_OBJECT_KIND::WALL_BLOCK || _targetData.tag == COLLISION_OBJECT_KIND::BACK_BLOCK)
	{
		// 押し戻し
