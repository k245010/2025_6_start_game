...
JumpPad::JumpPad(const Transform& _trans, const int& _hModel, const int& _hp, const PUT_PLACE_KIND& _putPlaceKind) : EntityBase(_trans,_hModel,StageObjectData::STAGE_OBJECT_KIND::JUMP_PAD,_hp,_putPlaceKind)
{
